  ...
  if (anonymizeInDevlopment && (process.env.NODE_ENV === 'development' || process.env.NODE_ENV === 'staging')) {
    ...
    Api.Clients.find({}).fetch().map(({ _id }) => {
      Api.Clients.update({ _id }, {
        $set: {
          clientKey: Random.id() + Random.id() + Random.id() + Random.id() + Random.id() + Random.id() + Random.id() + Random.id() + Random.id() + Random.id() + Random.id() + Random.id() + Random.id() + Random.id() + Random.id() + Random.id() + Random.id() + Random.id() + Random.id() + Random.id() + Random.id() + Random.id() + Random.id() + Random.id()
        }
      })
    })
