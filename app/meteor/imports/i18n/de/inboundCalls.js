export const inboundCalls = {
  this: 'Anrufe',
  thisSingular: 'Anruf',
  thisOpen: 'Offene Anrufe',
  thisResolved: 'Erledigte Anrufe',
  thisNew: 'Neuer Anruf',
  thisInsert: 'Neuer Anruf',
  thisSave: 'Neuen Anruf speichern',
  resolvedToday: 'heute erledigt',
  empty: 'Es sind momentan keine offenen Anrufe zu bearbeiten.',
  emptyResolved: 'Keine Anrufe sind als erledigt markiert.',
  postError: 'Hoppla! Bitte noch einmal versuchen.',
  postSuccess: 'Anruf eingetragen',
  insurance: 'Kasse',
  private: 'Privat',
