...
$sEoswinExe = "S:\Eoswin\ADSPraxis.exe"
...
Func LaunchCountdown()
  $sTitle = "Einen Moment bitte"
  $sMessage = "Das System wird jetzt den Tagesbericht erstellen. Bitte EOSWin auf diesem PC schließen und diesen PC währenddessen nicht verwenden. Danke!"
  MsgBox($MB_ICONINFORMATION + $MB_TOPMOST, $sTitle, $sMessage, 20)
  Sleep(10)
EndFunc
 
Func DoneMessage()
  $sTitle = "Danke für die Geduld"
  $sMessage = "Der Tagesbericht wurde erfolgreich erstellt"
  MsgBox($MB_ICONINFORMATION, $sTitle, $sMessage, 6)
EndFunc
...
Func CloseEOSWin($iRetries = 4)
  ...
  $hMainWnd = WinWait("EOSWin Ordination", "Patienten", 2)
